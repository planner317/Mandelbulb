...
function Slider(o, i, name) {
  ...
  this.down = function (e) {
    ...
    addEventHandler(document, 'pointermove', self.move);
    addEventHandler(document, 'pointerup', self.up);
    return false;
  }
  ...
  this.up = function (e) {
    removeEventHandler(document, 'pointermove', self.move);
    removeEventHandler(document, 'pointerup', self.up);
  ...
  */
  ...
  this.destructor = function () {
    self.o.onpointerover = null;
    self.o.onpointerout = null;
    self.o.onpointerdown = null;
    self.o = null;
    self.oV = null;
  ...
  this.o.onpointerdown = this.down;
  self.update();
}
